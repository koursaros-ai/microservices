...
#     .add_encoder(name='textbyte', yaml_path='max1024.yml',  replicas=4)
...
flow = (
    Flow()
    .add_router(yaml_path='BaseRouter')
    .add_preprocessor(name='unary', yaml_path='BasePreprocessor', doc_type=1)
    .add_encoder(name='textbyte', yaml_path='BaseEncoder',  replicas=4)
)