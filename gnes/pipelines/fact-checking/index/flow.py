...
flow = (
    ...
    .add_preprocessor(name='sent-split', replicas=2, yaml_path='json-mode.yml')
    .add_encoder(name='siamese-bert', replicas=2, yaml_path='dim-64.yml')
    .add_indexer(name='faiss-cpu', replicas=2, yaml_path='base.yml')
    .add_encoder(name='text-byte', recv_from='sent-split', replicas=2, yaml_path='max-256.yml')
