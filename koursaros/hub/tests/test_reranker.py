...
from koursaros.hub.router.rerank.rerank import RerankRouter
...
class TestReranker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reranker = RerankRouter.load_yaml(self.rerank_router_yaml)
    ...
    def test_reranker(self):
        msg = gnes_pb2.Message()
        msg.request.index.docs.extend([gnes_pb2.Document(raw_text="Test") for _ in range(5)])
        msg.envelope.num_part.extend([1, 3])
        res = self.reranker.apply(msg, [])
        print(res)
